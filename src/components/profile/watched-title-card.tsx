    ...
    >
      {canRemove && (
        <button
          ...
          className="absolute right-2 top-2 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-background/80 text-foreground-muted opacity-100 backdrop-blur-sm transition-opacity hover:text-danger md:opacity-0 md:group-hover:opacity-100"
        >
          <X size={14} />
        </button>
      )}
