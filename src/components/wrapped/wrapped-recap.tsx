...
export function WrappedRecap({
  ...
  return (
    <div>
      <p className="font-display text-xs font-semibold uppercase tracking-wide text-accent">Slate Wrapped</p>
      <h1 className="text-gold-foil font-section-heading mt-1 text-4xl">{headline}</h1>
