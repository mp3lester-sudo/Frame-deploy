 ...
 */
export function SignaturePickCard({ pick }: { pick: SignaturePick }) {
  ...
  return (
    ...
    >
      <div className="grid gap-5 sm:grid-cols-[140px_minmax(0,1fr)] sm:gap-x-6">
        <Link
          href={href}
          className="relative mx-auto h-[210px] w-[140px] shrink-0 overflow-hidden rounded-[var(--radius-md)] bg-surface-raised shadow-[0_20px_44px_-14px_rgba(0,0,0,0.7),0_0_60px_2px_rgba(217,184,118,0.5)] sm:col-start-1 sm:row-start-1 sm:row-span-2 sm:mx-0"
        >
          {posterImage && (
        ...
        <div className="text-center sm:col-start-2 sm:row-start-1 sm:text-left">
          <Link href={href} className="block">
            ...
            <h2 className="font-display mt-1 text-2xl text-foreground sm:text-3xl">{title.name}</h2>
