  ...
  return (
    <section className="mx-auto max-w-2xl px-4 py-14">
      ...
      <div className="mt-8 flex flex-col gap-8 text-sm leading-relaxed text-foreground-muted">
        <p>
          These terms govern your use of Slate (&ldquo;we,&rdquo; &ldquo;us&rdquo;). By creating an
        ...
        <div>
          ...
          <p className="mt-3">
            ...
            secure. You must be at least 13 years old to use Slate. You can delete your account at any
        ...
        <div>
          ...
          <p className="mt-3">
            ...
            Slate a license to display it back to you and other users as part of the ordinary
        ...
        <div>
          ...
          <p className="mt-3">
            Don&apos;t use Slate to harass other users, impersonate someone else, scrape or bulk-export
        ...
        <div>
          <h2 className="font-section-heading text-lg text-foreground">Slate Premium</h2>
          <p className="mt-3">
        ...
        <div>
          ...
          <p className="mt-3">
            Slate is provided &ldquo;as is,&rdquo; without warranties of any kind. To the extent
        ...
        <div>
          ...
          <p className="mt-3">
            We may update these terms as the app changes. Continuing to use Slate after an update means
